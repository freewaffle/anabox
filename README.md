...
Anabox is a dynamic top-down 2D shooter with focus on chaos and destruction.

# Repo structure

The game's repo is split into these directories:

- `components` folder contains important game components, such as tilesources and sprites.
- `dmdata` folder contains various files that are readed by Defold for building the game.
